...
public class StaticDefinitions extends JavaOverrideHelper {
  public StaticDefinitions(Map<SegmentedAddress, FunctionInformation> functionInformations, int segment,
      Machine machine) {
    super(functionInformations, "ida", machine);
    defineFunctions(segment);
    defineGlobals(segment);
  }

  private void defineFunctions(int segment) {
  ...
  private void defineGlobals(int segment) {
    int vgaSegment = segment + 0x234B;
